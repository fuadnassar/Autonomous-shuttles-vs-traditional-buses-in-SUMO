...
def generate_sumo_persons_separated():
    ...
    HOME_SHOP_FILE = SCRIPT_DIR / "results_from_step_1/Home_desination_person_info.xlsx"
    SHOP_HOME_FILE = SCRIPT_DIR / "results_from_step_1/Destination_home_person_info.xlsx"
